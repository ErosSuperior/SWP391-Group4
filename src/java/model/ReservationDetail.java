...
public class ReservationDetail {
    ...
    public ReservationDetail(int reservation_detail_id, int reservation_id, int service_id, String service_title, double price, int quantity, int category_id, String category_name, int staff_id, Date begin_time, int slot, int children_id) {
