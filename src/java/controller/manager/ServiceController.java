 ...
 * @author CMD
 */
@WebServlet(name = "ServiceListController", urlPatterns = {"/manager/ServicesList", "/manager/ServicesList/Add", "/manager/ServicesList/Update", "/manager/ServicesList/Delete"})
public class ServiceController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (url) {
            case "/manager/ServicesList":
                handleServiceList(request, response);
                break;
            case "/manager/ServicesList/Add":
                break;
            case "/manager/ServicesList/Update":
                break;
            case "/manager/ServicesList/Delete":
                break;
        }
    }
