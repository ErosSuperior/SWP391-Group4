                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <div class="row">
                            ...
                            <form action="${pageContext.request.contextPath}/StaffList" method="GET"
                                  class="row">
                                <!-- Filters -->
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-primary ms-2" type="button"
                                                    onclick="window.location.href = '${pageContext.request.contextPath}/StaffList'">
                                ...
                                <div class="col-md-2 d-flex align-items-end justify-content-end" style="margin-left: 275px">
                                    <button class="btn btn-primary btn-md"
                                            onclick="window.location.href = '${pageContext.request.contextPath}/StaffDetailAdd'"
                                            type="button">
                                        ...
                                        <table class="table table-center bg-white mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom p-3" style="min-width: 180px;">Staff Name
                                                    </th>
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.allblogs}" var="d">
                                                    <tr>
                                                        <th class="p-3">${d.user_id}</th>
                                                        <td class="py-3">
                                                            <a href="#" class="text-dark">
                                                                <div class="d-flex align-items-center">
                                                                    <img src="${d.user_image}" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                                                    <span class="ms-2">${d.user_fullname}</span>
                                                                </div>
                                                            </a>
                                                        </td>
                                                        <td class="p-3">
                                                            <c:choose>
                                                                <c:when test="${d.user_gender == true}">
                                                                    <span class="text-primary"><i class="uil uil-mars"></i> Male</span>
                                                                </c:when>
                                                                <c:when test="${d.user_gender == false}">
