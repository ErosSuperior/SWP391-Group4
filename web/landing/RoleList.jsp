...
<html>
    ...
    <body>
                                ...
                                <div class="card rounded shadow">
                                    <div class="p-4 border-bottom">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="${pageContext.request.contextPath}/admin/addRole" class="btn btn-primary">
                                    ...
                                    <div class="p-4">
                                        <form action="${pageContext.request.contextPath}/admin/roleList" method="GET" class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    ...
                                                    <button type="button" class="btn btn-primary form-control" 
                                                            onclick="window.location.href = '${pageContext.request.contextPath}/admin/roleList'">
                                            ...
                                            <table class="table table-center bg-white mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.allRoles}" var="role">
                                                        <tr>
                                                            <th class="p-3">${role.role_id}</th>
                                                            <td class="p-3">${role.role_name}</td>
                                                            <td>
                                                                <c:choose>
                                                            ...
                                                            <td class="p-3">
                                                                <a href="${pageContext.request.contextPath}/admin/editRole?roleId=${role.role_id}"
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${role.status == 1}">
                                                                        <button class="btn btn-icon btn-pills btn-soft-danger"
                                                                                ...
                                                                                onclick="showConfirmationModal(${role.role_id}, 0)"
                                                                    ...
                                                                    <c:otherwise>
                                                                        <button class="btn btn-icon btn-pills btn-soft-success"
                                                                                data-role-id="${role.role_id}"
                                                                                onclick="showConfirmationModal(${role.role_id}, 1)"
                                                    ...
                                                    <ul class="pagination justify-content-center mb-0 mt-3 mt-sm-0">
                                                        <c:forEach begin="0" end="${(totalElements + pageSize - 1) / pageSize - 1}" var="i">
                                                            <li class="page-item ${pageNo == i ? 'active' : ''}">
                                                                <a class="page-link" href="${pageContext.request.contextPath}/admin/roleList?pageNo=${i}&nameOrId=${param.nameOrId}">
                                                                    ${i + 1}
                                                                </a>
                                                            </li>
                                                        </c:forEach>
        ...
        <script>
                                                                                    ...
                                                                                    function showConfirmationModal(roleId, status) {
                                                                                        ...
                                                                                        if (status === 0) {
                                                                                            ...
                                                                                            modalMessage.innerText = "Are you sure you want to deactivate this role?";
                                                                                            confirmButton.innerText = "Deactive";
                                                                                            confirmButton.className = "btn btn-danger";
                                                                                        } else {
                                                                                            modalTitle.innerText = "Confirm Activation";
                                                                                            modalMessage.innerText = "Are you sure you want to activate this role?";
                                                                                    ...
                                                                                    $('#confirmActionButton').click(function () {
                                                                                        changeStatusRole(currentRoleId, currentStatus);
                                                                                        $('#confirmationModal').modal('hide');
                                                                                    });

                                                                                    function changeStatusRole(currentRoleId, currentStatus) {
                                                                                        $.ajax({
